...
set_mapping("n", "<localleader>a", "ReactEmoji", function()
	require("neoment.room").react_message("emoji")
end, set_opts_desc("Re[a]ct message"))
set_mapping("n", "<localleader>A", "ReactText", function()
	require("neoment.room").react_message("text")
end, set_opts_desc("Re[A]ct message with text"))
...
set_mapping("n", "<localleader>i", "ShowRoomInfo", function()
	require("neoment.room").show_room_info()
...
set_mapping("n", "<localleader>V", "ShowEvent", function()
	require("neoment.room").show_event()
end, set_opts_desc("Show e[V]ent data"))
