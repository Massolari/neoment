...
vim.keymap.set("n", "q", "<Plug>NeomentToggleRoomsList", { remap = true, buffer = buffer_id })
...
set_mapping("n", "<localleader>d", "ToggleDirect", function()
	require("neoment.rooms").toggle_direct()
end, set_opts_desc("Toggle [D]irect"))
set_mapping("n", "<localleader>i", "ShowRoomInfo", function()
	require("neoment.rooms").show_room_info()
end, set_opts_desc("Show room [i]nfo"))
...
set_mapping("n", "<localleader>s", "ChangeStatus", function()
	require("neoment.rooms").change_status()
end, set_opts_desc("Change [S]tatus"))
set_mapping("n", "<localleader>u", "RefreshRoomState", function()
	require("neoment.rooms").refresh_room_state()
end, set_opts_desc("[U]pdate room state"))
